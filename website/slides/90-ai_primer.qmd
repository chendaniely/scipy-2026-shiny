...
## More AI + LLM at SciPy

For more AI things, follow these other LLM tutorials from SciPy:

- **Build a Deep Research Agent**: Ben Batorsky & Eric Ma
    - <https://github.com/ericmjl/build-deep-research-agent>
- **Safe & Maintainable AI Apps in Python**: Carson Sievert
    - <https://github.com/cpsievert/scipy26-tutorial>
...
- Treat LLMs as **black boxes**: you send text in, text comes back
...
Run `code/demos/ai-01-chatlas-github.py`, then `code/demos/ai-02-dotenv.py`.
:::
