...
- Run `code/demos/app-90-querychat.py`
- Or click and run: [View App](https://posit-ai-querychat.share.connect.posit.cloud/) · [View Code](https://github.com/posit-dev/py-shiny-templates/tree/main/gen-ai/querychat)
:::
...
Template: `shiny create --github jcheng5/py-sidebot`

::: {.callout-tip}
## 🎯 Live Demo

Click and run: [View App](https://jcheng.shinyapps.io/sidebot) · [View Code](https://github.com/jcheng5/py-sidebot)
:::
...
See exercise: [AI Dashboards](../exercises.qmd#ex-ai-dashboards).

## SQL is a great communication layer

Upcoming tool: ggsql <https://ggsql.org/>

Try it: <https://ggsql.org/wasm/>
