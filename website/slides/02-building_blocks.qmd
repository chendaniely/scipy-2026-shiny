...
- Rebuilds only the outputs that depend on the changed input
- No callbacks
- No manual refresh
- No cache management
...
- Change a value cell, and only its dependent formula cells recalculate
...
There is full feature parity between the 2 syntax modes.
