...
Check the GitHub Actions of the install tests on different python versions here: <https://github.com/chendaniely/scipy-2026-shiny/actions/workflows/test-install.yml>
:::
...
```bash
conda create -n scipy2026 python=3.12
conda activate scipy2026
pip install -r requirements.txt
```
...
After installing the Python packages (with your environment active), install the Chromium browser that Playwright will use:
...
1. Clone or download this repository: <https://github.com/chendaniely/scipy-2026-shiny>
